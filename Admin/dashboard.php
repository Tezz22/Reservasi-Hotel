...
<html lang="en" data-bs-theme="auto">
    ...
    <body>
        ...
        <main>
            ...
            <div class="row">
                <div class="d-flex justify-content-center gap-3 py-3 mb-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahKamarModal">
                        Tambah Kamar
                    </button>
                    <button class="btn btn-primary" onclick="window.location.href='reservasi_admin.php'">
                        Reservasi
                    </button>
                    <button class="btn btn-primary" onclick="window.location.href='laporan.php'">
                        Laporan
                    </button>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                ...
                <form method="POST" action="../Model/input_kamar.php" enctype="multipart/form-data">
            ...
            <div class="album py-5 bg-body-tertiary">
                <div class="container">
                    <?php include __DIR__ . '/../View/component/tampil_kamar.php'; ?>
                </div>
            </div>
