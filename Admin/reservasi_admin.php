...
require_once '../Model/reservasi.php';

$reservasiModel = new Reservasi();
$reservasiList = $reservasiModel->getAllReservasi();
$judul_section = "Reservasi";
$isi_section = "---";
?>
...
<html lang="en" data-bs-theme="auto">
    ...
    <body>
        ...
        <header data-bs-theme="dark">
            <?php include __DIR__ . '/../View/component/tampil_header.php'; ?>
        </header>

        <main>
            <section class="py-5 text-center container">
                <?php include __DIR__ . '/../View/component/tampil_section.php'; ?>
            </section>
                    ...
                    <tbody>
                        ...
                        <?php else : ?>
                            <?php foreach ($reservasiList as $reservasi) : ?>
                                <tr>
                                    <td><?= $reservasi['id'] ?></td>
                                    <td><?= $reservasi['pengguna_id'] ?></td>
                                    <td><?= $reservasi['kamar_id'] ?></td>
                                    <td><?= $reservasi['check_in'] ?></td>
                                    <td><?= $reservasi['check_out'] ?></td>
                                    <td>
                                        <span class="badge bg-<?= 
                                            $reservasi['status'] === 'terkonfirmasi' ? 'success' : 
                                            ($reservasi['status'] === 'dibatalkan' ? 'danger' : 'secondary') ?>">
                                            <?= ucfirst($reservasi['status']) ?>
                                        </span>
                                    </td>
                                    <td>
                                        <form method="POST" action="../Model/edit_reservasi.php" class="d-inline">
                                            ...
                                            <select name="status" class="form-select form-select-sm" onchange="this.form.submit()">
                                                ...
                                                <option value="terkonfirmasi" <?= $reservasi['status'] == 'terkonfirmasi' ? 'selected' : '' ?>>Terkonfirmasi</option>
        ...
        <footer class="text-body-secondary py-5">
            <?php include __DIR__ . '/../View/component/tampil_footer.php'; ?>
        </footer>
